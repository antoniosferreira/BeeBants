...
class GuideViewController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate  {
    ...
    override func viewDidLoad() {
        ...
        for c in 1 ... 5 {
            let vc = UIStoryboard(name: "Guide", bundle: nil).instantiateViewController(withIdentifier: "GCONTENT") as! GuideContentViewController
    ...
    @IBAction func nextButtonTapped(_ sender: UIButton) {
        ...
        guard let nextViewController = pageController.dataSource?.pageViewController( self.pageController, viewControllerAfter: currentViewController ) else {
            ...
            let lastPage = UIStoryboard(name: "Home", bundle: nil).instantiateViewController(withIdentifier: "MAIN_SB") as! HomeViewController
    ...
    func updateDots() {
        let currentViewController = self.pageController.viewControllers?.first as! GuideContentViewController
